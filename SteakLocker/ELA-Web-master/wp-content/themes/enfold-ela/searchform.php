...
$search_params = apply_filters('avf_frontend_search_form_param', array(
    ...
    'placeholder'  	=> __('Search by keyword or phrase','avia_framework'),
    'search_id'	   	=> 's',
...
<form action="<?php echo $search_params['form_action']; ?>" id="searchform" method="get" data-name="Search ELA Help" class="ela-simple-form <?php echo $disable_ajax; ?>">
