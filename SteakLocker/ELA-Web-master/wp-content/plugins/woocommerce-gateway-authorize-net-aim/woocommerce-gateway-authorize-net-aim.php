...
SV_WC_Framework_Bootstrap::instance()->register_plugin( '4.6.5', __( 'WooCommerce Authorize.Net AIM Gateway', 'woocommerce-gateway-authorize-net-aim' ), __FILE__, 'init_woocommerce_gateway_authorize_net_aim', array(
