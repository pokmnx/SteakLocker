...
if ( !class_exists( 'avia_sc_product_teaser_box' ) )
{
    class avia_sc_product_teaser_box extends aviaShortcodeTemplate
    {
        /**
        ...
        {
            $this->config['name']		= __('Product Teaser Box', 'avia_framework' );
            $this->config['tab']		= __('Content Elements', 'avia_framework' );
            $this->config['icon']		= AviaBuilder::$path['imagesURL']."sc-magazine.png";
            $this->config['order']		= 1;
            $this->config['target']		= 'avia-target-insert';
            $this->config['shortcode'] 	= 'av_product_teaser_box';
            $this->config['shortcode_nested'] = array('av_product_teaser_icon');
            $this->config['tooltip'] 	= __('Display a product teaser box', 'avia_framework' );
        }
